...
## [0.34.0](https://github.com/instill-ai/artifact-backend/compare/v0.33.0...v0.34.0) (2026-06-01)


### ⚠ BREAKING CHANGES

* **artifact:** R3 rename parent_project → parent_folder (CE side) ([#358](https://github.com/instill-ai/artifact-backend/issues/358))
...
* **artifact:** add file copy and object copy support for EE collection clone ([#338](https://github.com/instill-ai/artifact-backend/issues/338)) ([76402f4](https://github.com/instill-ai/artifact-backend/commit/76402f403d4327da3c2451144a855e669486b1a6))
* **artifact:** add is_text_based classification, blob resolution endpoint, and correction merge prompt ([6dd4c94](https://github.com/instill-ai/artifact-backend/commit/6dd4c9442f9400e0269f64c910adc8c78bd97785))
...
* **artifact:** add SVG and JSON file type support and fix large-file chunking ([0b603eb](https://github.com/instill-ai/artifact-backend/commit/0b603eb48b496edb6f9c28bfb1ef548a074b46fa))
...
* **artifact:** block duplicate file uploads via SHA256 content hash ([1832c1e](https://github.com/instill-ai/artifact-backend/commit/1832c1ece738c550f499f36915ff1a25e78d0dea))
* **artifact:** expose content_sha256 field in File API responses ([62c05ac](https://github.com/instill-ai/artifact-backend/commit/62c05acb9dcce36142bcaf0ec944caa0e404c81b))
...
* **artifact:** R3 rename parent_project → parent_folder (CE side) ([#358](https://github.com/instill-ai/artifact-backend/issues/358)) ([b23f769](https://github.com/instill-ai/artifact-backend/commit/b23f769c4d74f232d3edbed5f26ea4f70b8ed863))
...
* **file:** add visibility field and protobuf wiring ([#345](https://github.com/instill-ai/artifact-backend/issues/345)) ([ff25582](https://github.com/instill-ai/artifact-backend/commit/ff25582e7458f83601cbd45bd4c0df4cea856b4b))
* **files:** thumbnail generation + list-view fan-out + reprocessing cleanup ([0781b97](https://github.com/instill-ai/artifact-backend/commit/0781b97eeeb646310cefd014e72d99974e3b8645))
* **handler:** add q filter for fuzzy file search on display name, ID, and description ([e6ce9e3](https://github.com/instill-ai/artifact-backend/commit/e6ce9e38234fe53af35fe4adf345498f230c3df3))
* **handler:** populate File.ParentProject from DB column in API responses ([#356](https://github.com/instill-ai/artifact-backend/issues/356)) ([33c872d](https://github.com/instill-ai/artifact-backend/commit/33c872d2ffe82f2938e3faf439da47d3c758a2ec))
* **handler:** support permission clauses in ListFilesAdmin ([#352](https://github.com/instill-ai/artifact-backend/issues/352)) ([5794ee6](https://github.com/instill-ai/artifact-backend/commit/5794ee6274cd2337cfb7f179ba34a42496017004))
...
* **knowledge-base:** add alias backfill + hybrid-search ranker signal + media fail-fast ([6a8eb9f](https://github.com/instill-ai/artifact-backend/commit/6a8eb9f26e7fcbdf4ee622efa49f24053fc09f6f))
...
* **object:** add on-demand PDF conversion for GetObjectDownloadURL ([40ae79a](https://github.com/instill-ai/artifact-backend/commit/40ae79a93b37101b70c7bfe3cb6efc7eeece96a1))
* **object:** add streaming GetFileReader and UploadFromReader to Storage interface ([27ab4f4](https://github.com/instill-ai/artifact-backend/commit/27ab4f4bd62759cca0c184dca4e7ebe5b658af7b))
...
* **repo,handler:** add FilePermissionFilter for push-down per-row authorization ([#351](https://github.com/instill-ai/artifact-backend/issues/351)) ([48d735f](https://github.com/instill-ai/artifact-backend/commit/48d735fb238f0d68151150d440a7b8fc8823e036))
* **repo:** enforce per-KB unique content_sha256 to prevent duplicate file uploads ([d56dde9](https://github.com/instill-ai/artifact-backend/commit/d56dde9e027bd3ee290ccf29c5b96da5479480d4))
...
* **worker:** add ConvertVideoRange with segment overlap lookback for accurate boundary timestamps ([a7aab91](https://github.com/instill-ai/artifact-backend/commit/a7aab91fbbfbc46df4bafc2850c57b326b50ae40))
* **worker:** add ffmpeg remux for video files in StandardizeFileTypeActivity ([643165e](https://github.com/instill-ai/artifact-backend/commit/643165e319f9fa1a984d1f266e0aedfaa56b3b2a))
* **worker:** add file chunk integrity probe, fix reprocess idempotency race, and graceful Milvus degradation ([941c1bd](https://github.com/instill-ai/artifact-backend/commit/941c1bd9a24edbc3e6e1e2d746d2747b3b245a4b))
* **worker:** add file processing usage tracking and failure callbacks ([#336](https://github.com/instill-ai/artifact-backend/issues/336)) ([be5b2fe](https://github.com/instill-ai/artifact-backend/commit/be5b2fe41a8bfface6e57c8f41d3935cc11a89fb))
* **worker:** add media time-range chunk references, clear stale patches on reprocess, and improve retry resilience ([9bc3dcd](https://github.com/instill-ai/artifact-backend/commit/9bc3dcd8d86a9a8c359eeef42ce30148aa999f92))
* **worker:** add patch merge for RAG-indexed content with windowed LLM strategy ([87fbd4c](https://github.com/instill-ai/artifact-backend/commit/87fbd4c70b5e3940690e07be4b00464e03c341ec))
* **worker:** add spreadsheet chunking, entity graph, and search improvements ([6160f28](https://github.com/instill-ai/artifact-backend/commit/6160f28b3eb3ee08e78561c34b0a82bf1a9707ac))
* **worker:** chunked media conversion, upgraded Gemini model, and orphan sweeper ([24e38be](https://github.com/instill-ai/artifact-backend/commit/24e38bee18f861207a3f94e65316ddbfc489a7ad))
* **worker:** hybrid two-pass audio/visual processing for video files ([468a852](https://github.com/instill-ai/artifact-backend/commit/468a852c446fde59636bb3d6f37e22da141e64dc))
...
* **worker:** relay RAG model usage metadata ([886abc4](https://github.com/instill-ai/artifact-backend/commit/886abc48f7d362e623903100a150f629b6114a80))
* **worker:** replace continuous GCS cleanup with Temporal Schedules and add expired-object purge ([2b6e878](https://github.com/instill-ai/artifact-backend/commit/2b6e8783fdb25416a632d9f8ca321536ed863a04))


### Bug Fixes

* **acl:** adapt ListPermissions wrapper to x v0.10.1-alpha (post-[#89](https://github.com/instill-ai/artifact-backend/issues/89)/[#90](https://github.com/instill-ai/artifact-backend/issues/90)) ([#347](https://github.com/instill-ai/artifact-backend/issues/347)) ([113b367](https://github.com/instill-ai/artifact-backend/commit/113b36728fe85c4cc5528344f7b0559a1f8aca29))
...
* **artifact:** scope duplicate file check per-KB and add unique constraint for KB slugs ([843e180](https://github.com/instill-ai/artifact-backend/commit/843e180059e17b42e1ef752d33d655d888ab0b4c))
* **chunk:** add trusted-backend bypass for ListChunks ACL ([#355](https://github.com/instill-ai/artifact-backend/issues/355)) ([059d935](https://github.com/instill-ai/artifact-backend/commit/059d935fd34123a46fe220e468fd89e48ba1bb9a))
...
* **db:** widen knowledge_base usage column to bigint to prevent overflow ([0eaf9fc](https://github.com/instill-ai/artifact-backend/commit/0eaf9fc6f7ee51647f3c012e6a6ca10d138a3c54))
* **deps:** bump x for OpenFGA gRPC dns:/// + round_robin LB fix ([8fa25e5](https://github.com/instill-ai/artifact-backend/commit/8fa25e57707e2e3f1a553ac54cff5ce46e55bcbe))
* **deps:** bump x for periodic DNS re-resolution resolver ([ac43b14](https://github.com/instill-ai/artifact-backend/commit/ac43b14f30d7b5ce57e59a6a9feff2712f33b29d))
* **docker:** install ffmpeg in production image for media duration probing ([fd655d4](https://github.com/instill-ai/artifact-backend/commit/fd655d458b748857ccabba9e8531b7380256d837))
* **handler:** accept parent_project in UpdateFileAdmin field mask ([#357](https://github.com/instill-ai/artifact-backend/issues/357)) ([4910515](https://github.com/instill-ai/artifact-backend/commit/4910515c05b5d4d08f4a1cd62f16760f3a602370))
* **handler:** batch-fetch objects in ListFilesWithPermissionFilter to eliminate N+1 ([9b4c6d5](https://github.com/instill-ai/artifact-backend/commit/9b4c6d52d0a1cbc4196c62164f29cf1a70e8828b))
...
* **handler:** populate CreatorName in File response for DiceBear avatar seeding ([#343](https://github.com/instill-ai/artifact-backend/issues/343)) ([a09cecf](https://github.com/instill-ai/artifact-backend/commit/a09cecf601bb89973131f8ade4108700849dd07b))
* **handler:** replace embedded owner/creator with denormalized display fields ([#342](https://github.com/instill-ai/artifact-backend/issues/342)) ([3729cf2](https://github.com/instill-ai/artifact-backend/commit/3729cf209f7de31a62b7a78968169180af55f8e5))
...
* **handler:** sync object display_name when file is renamed via UpdateFile ([e755eba](https://github.com/instill-ai/artifact-backend/commit/e755eba13f8c0b4d68ea67dc099e3d16e2f107b2))
...
* **milvus:** non-blocking client init and async embedding tag sync ([3187e60](https://github.com/instill-ai/artifact-backend/commit/3187e604c881102a4f16845748cfecdef456032f))
* **object:** resume truncated GCS stream copies ([f6cb717](https://github.com/instill-ai/artifact-backend/commit/f6cb7178902fc8517a4ac7d2d64469e41b629ac7))
...
* push down file list filters ([0712a79](https://github.com/instill-ai/artifact-backend/commit/0712a79cb87ee1cfaf0f11b99be1e76c88550c10))
* **rag:** account input characters for direct Gemini embedding usage ([#361](https://github.com/instill-ai/artifact-backend/issues/361)) ([9354e7a](https://github.com/instill-ai/artifact-backend/commit/9354e7a9b861f67788b5ed8c396cf4781b29c3ac))
* **repo:** clear content hash on file delete ([b48bdae](https://github.com/instill-ai/artifact-backend/commit/b48bdae72c251fb7acbc9f0d3d0a0780638f2870))
...
* **service:** add visitor auth support to CheckNamespacePermission ([#344](https://github.com/instill-ai/artifact-backend/issues/344)) ([24c19fe](https://github.com/instill-ai/artifact-backend/commit/24c19fe61779c734517a3bd79ee70a4cba9e67ed))
...
* **test:** update DefaultCacheTTL assertion to match 10min value ([3ee302c](https://github.com/instill-ai/artifact-backend/commit/3ee302c9b21e422038b41224c9cecb176d4077cf))
...
* **worker:** accept PROCESSING status for patch-only detection and preserve preview files ([ef8100f](https://github.com/instill-ai/artifact-backend/commit/ef8100ff33d2a6d5bceecdd55675430366e3b9b7))
...
* **worker:** eliminate reprocess-status flicker by persisting PROCESSING immediately ([#354](https://github.com/instill-ai/artifact-backend/issues/354)) ([aaabd98](https://github.com/instill-ai/artifact-backend/commit/aaabd989e4edd966600f6d509307c78ae9db7c3c))
* **worker:** gate chunked-conversion signal on Gemini cache availability ([de02a53](https://github.com/instill-ai/artifact-backend/commit/de02a53c0021e34b2a6983c7edb6279ff82a8236))
* **worker:** handle large PDF DEADLINE_EXCEEDED with chunked conversion fallback ([74dec26](https://github.com/instill-ai/artifact-backend/commit/74dec26af10c143d765bd644d938fafebb46ea53))
...
* **worker:** preserve standard file types during reprocessing for uninterrupted preview ([a702b78](https://github.com/instill-ai/artifact-backend/commit/a702b78a77c98265480d52a325f34e79b4fc34ce))
...
* **worker:** resolve bucket from storage_path in BackfillThumbnailsWorkflow ([328ccaa](https://github.com/instill-ai/artifact-backend/commit/328ccaad323cb15cc1493943e4c9831f09e12f4a))
* **worker:** terminate in-flight processing workflow before file cleanup ([163001d](https://github.com/instill-ai/artifact-backend/commit/163001d666b0cde0daf1357f54bc553384f4dc62))
* **worker:** use GCS storage for CleanupExpiredGCSFilesActivity ([a90c09e](https://github.com/instill-ai/artifact-backend/commit/a90c09ee5da6a62edf1beff50f89300f03b60494))
* **worker:** use server-side copy in StandardizeFileTypeActivity to prevent OOM ([41b8e75](https://github.com/instill-ai/artifact-backend/commit/41b8e758e620fe8605df745bd15b5375e73a16b9))


### Miscellaneous

* **ci:** remove maximize-build-space action ([917eb68](https://github.com/instill-ai/artifact-backend/commit/917eb6868a4cfa2939c337cb2e733b1d1722b585))
...
* **deps:** bump github.com/instill-ai/x for gRPC client-side LB ([6230b5b](https://github.com/instill-ai/artifact-backend/commit/6230b5b16859c5fd4b652444782116e6f238bee6))
...
* **deps:** bump protogen-go for File view / thumbnail / chunk grouping ([00048be](https://github.com/instill-ai/artifact-backend/commit/00048be13a2a8f65c596f455f29da1bdad6fb2ce))
* **deps:** bump protogen-go to cfe7b8e for CopyFileToKnowledgeBaseAdmin RPC ([5708608](https://github.com/instill-ai/artifact-backend/commit/57086088b0ec92b2e1a0ce205462344ff83ba97f))
* **deps:** bump x for cache split, truncation guard, and ReadTuples ([#350](https://github.com/instill-ai/artifact-backend/issues/350)) ([c433572](https://github.com/instill-ai/artifact-backend/commit/c4335726f4fc1c7756dda6cfef9dfcf8baf8d4bb))
...
* **deps:** bump x to pick up ListPermissions Redis cache ([#348](https://github.com/instill-ai/artifact-backend/issues/348)) ([b28766a](https://github.com/instill-ai/artifact-backend/commit/b28766af137d3f1047736e2d8ab790621ef3c0ef))
...
* **mock:** regenerate handler repository mock for entity methods ([c55cc36](https://github.com/instill-ai/artifact-backend/commit/c55cc3617fa6a84adf05035611a20e86cd3d246c))
* release v0.34.0 ([851a3dc](https://github.com/instill-ai/artifact-backend/commit/851a3dc21736d9fc598cfcc219b156215b09a170))


### Documentation

* add AGENTS.md + decouple search docs from agent-backend-ee ([aa19283](https://github.com/instill-ai/artifact-backend/commit/aa19283e26d3e5979deb30afa4549ca9773d5b4f))
* add CE-doc self-containment invariant + view-propagation gotcha ([878c1b2](https://github.com/instill-ai/artifact-backend/commit/878c1b2ee4e4e698f8753d6ac9ea4516a0b8f48f))
* **blob:** document Range / partial-content support in gateway path ([2b2027b](https://github.com/instill-ai/artifact-backend/commit/2b2027b1087f09650bc9744526c91cd5a1d96b0e))
* **comments:** refresh console-ee C-INV cross-refs after renumber ([854abce](https://github.com/instill-ai/artifact-backend/commit/854abce09f5225ab31ea809248c225ef9b17f43c))
* **invariants:** split AGENTS.md into per-domain files and scrub EE references ([4e699cf](https://github.com/instill-ai/artifact-backend/commit/4e699cfc4193f4e0e077e5d47967dd54b2c330af))
...
* **storage:** add raw-bytes UploadFile, harden GCS upload and cache error handling ([fdf71c4](https://github.com/instill-ai/artifact-backend/commit/fdf71c4e019e384fe469196e5867cd57de4c696f))
...
* **worker:** simplify Gemini error handling with retry-by-default strategy ([a287d33](https://github.com/instill-ai/artifact-backend/commit/a287d33214638d1f070d106d2f8b0fe0ab49ccd4))


### Tests

* **artifact:** add unit tests for CreateFileAdmin and GetBlobObjectPath ([b061312](https://github.com/instill-ai/artifact-backend/commit/b0613123eaa5cf1e846e3134f91cca0016898757))
* **integration:** assert view fan-out on ListFiles in per-type group ([c6f4311](https://github.com/instill-ai/artifact-backend/commit/c6f43118d4816b8567a829fd9bdd0f6fa199c133))
