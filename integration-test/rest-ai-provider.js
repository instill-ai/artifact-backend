...
export default function (data) {
    ...
    group("AI Provider: Test Content Conversion with Gemini", function () {
        ...
        const processResp = http.request(
            "POST",
            `${apiHost}/v1alpha/catalogs/files/processAsync`,
            JSON.stringify({ fileUids: [fileUid] }),
            data.header
        );

        check(processResp, {
            "Gemini Test 2.2b: Trigger processing returns 200": (r) => r.status === 200,
        });
    ...
    group("AI Provider: Test Gemini Embedding Generation (3072-dim)", function () {
        ...
        check(uploadResp, {
            "Gemini Test 3.2: Upload file returns 200": (r) => r.status === 200,
        });
        ...
        check(processResp, {
            "Gemini Test 3.2b: Trigger processing returns 200": (r) => r.status === 200,
        });
...
3. Hire additional engineering staff
        ...
        check(uploadResp, {
            "Gemini Test 4.2: Upload file returns 200": (r) => r.status === 200,
        });
        ...
        check(processResp, {
            "Gemini Test 4.2b: Trigger processing returns 200": (r) => r.status === 200,
        });
    ...
    group("AI Provider: Test Gemini Cache Functionality", function () {
        ...
        check(uploadResp, {
            "Gemini Test 5.2: Upload file returns 200": (r) => r.status === 200,
        });
        ...
        check(processResp, {
            "Gemini Test 5.2b: Trigger processing returns 200": (r) => r.status === 200,
        });
