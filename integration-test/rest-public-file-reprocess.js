 ...
 * 3. New intermediate files and embeddings are created with fresh content
 * 4. All resource counts remain constant (proving old data was cleaned up)
 *
 * Test Flow:
 * - Upload a PDF file (full processing pipeline: convert → chunk → embed)
 * - Process it once, count MinIO blobs and embeddings (baseline)
