...
type RepositoryIMock struct {
	...
	funcListCatalogRuns          func(ctx context.Context, pageSize int64, page int64, filter filtering.Filter, order ordering.OrderBy, catalogUID string, requesterUID string, isOwner bool) (modelTriggers []*mm_repository.CatalogRun, totalSize int64, err error)
	inspectFuncListCatalogRuns   func(ctx context.Context, pageSize int64, page int64, filter filtering.Filter, order ordering.OrderBy, catalogUID string, requesterUID string, isOwner bool)
	afterListCatalogRunsCounter  uint64
	beforeListCatalogRunsCounter uint64
	ListCatalogRunsMock          mRepositoryIMockListCatalogRuns
	...
	funcUpdateCatalogRun          func(ctx context.Context, runUID uuid.UUID, run *mm_repository.CatalogRun) (err error)
	inspectFuncUpdateCatalogRun   func(ctx context.Context, runUID uuid.UUID, run *mm_repository.CatalogRun)
	afterUpdateCatalogRunCounter  uint64
	beforeUpdateCatalogRunCounter uint64
	UpdateCatalogRunMock          mRepositoryIMockUpdateCatalogRun
	...
	funcUpsertCatalogRun          func(ctx context.Context, run *mm_repository.CatalogRun) (cp1 *mm_repository.CatalogRun, err error)
	inspectFuncUpsertCatalogRun   func(ctx context.Context, run *mm_repository.CatalogRun)
	afterUpsertCatalogRunCounter  uint64
	beforeUpsertCatalogRunCounter uint64
	UpsertCatalogRunMock          mRepositoryIMockUpsertCatalogRun
...
func NewRepositoryIMock(t minimock.Tester) *RepositoryIMock {
	...
	m.ListCatalogRunsMock = mRepositoryIMockListCatalogRuns{mock: m}
	m.ListCatalogRunsMock.callArgs = []*RepositoryIMockListCatalogRunsParams{}
	...
	m.UpdateCatalogRunMock = mRepositoryIMockUpdateCatalogRun{mock: m}
	m.UpdateCatalogRunMock.callArgs = []*RepositoryIMockUpdateCatalogRunParams{}
	...
	m.UpsertCatalogRunMock = mRepositoryIMockUpsertCatalogRun{mock: m}
	m.UpsertCatalogRunMock.callArgs = []*RepositoryIMockUpsertCatalogRunParams{}
...
func (mmConvertedFileTableName *mRepositoryIMockConvertedFileTableName) Optional() *mRepositoryIMockConvertedFileTableName {
	mmConvertedFileTableName.optional = true
...
func (m *RepositoryIMock) MinimockConvertedFileTableNameDone() bool {
	if m.ConvertedFileTableNameMock.optional {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmDeleteAllConvertedFilesInKb *mRepositoryIMockDeleteAllConvertedFilesInKb) Optional() *mRepositoryIMockDeleteAllConvertedFilesInKb {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmDeleteAllKnowledgeBaseFiles *mRepositoryIMockDeleteAllKnowledgeBaseFiles) Optional() *mRepositoryIMockDeleteAllKnowledgeBaseFiles {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmDeleteAndCreateChunks *mRepositoryIMockDeleteAndCreateChunks) Optional() *mRepositoryIMockDeleteAndCreateChunks {
	mmDeleteAndCreateChunks.optional = true
...
func (m *RepositoryIMock) MinimockDeleteAndCreateChunksDone() bool {
	if m.DeleteAndCreateChunksMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmDeleteConvertedFile *mRepositoryIMockDeleteConvertedFile) Optional() *mRepositoryIMockDeleteConvertedFile {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmDeleteKnowledgeBaseFileAndDecreaseUsage *mRepositoryIMockDeleteKnowledgeBaseFileAndDecreaseUsage) Optional() *mRepositoryIMockDeleteKnowledgeBaseFileAndDecreaseUsage {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetChunksByUIDs *mRepositoryIMockGetChunksByUIDs) Optional() *mRepositoryIMockGetChunksByUIDs {
	mmGetChunksByUIDs.optional = true
...
func (m *RepositoryIMock) MinimockGetChunksByUIDsDone() bool {
	if m.GetChunksByUIDsMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetConvertedFileByFileUID *mRepositoryIMockGetConvertedFileByFileUID) Optional() *mRepositoryIMockGetConvertedFileByFileUID {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetCountFilesByListKnowledgeBaseUID *mRepositoryIMockGetCountFilesByListKnowledgeBaseUID) Optional() *mRepositoryIMockGetCountFilesByListKnowledgeBaseUID {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetFilesTotalTokens *mRepositoryIMockGetFilesTotalTokens) Optional() *mRepositoryIMockGetFilesTotalTokens {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetKnowledgeBaseByOwnerAndKbID *mRepositoryIMockGetKnowledgeBaseByOwnerAndKbID) Optional() *mRepositoryIMockGetKnowledgeBaseByOwnerAndKbID {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetKnowledgeBaseCountByOwner *mRepositoryIMockGetKnowledgeBaseCountByOwner) Optional() *mRepositoryIMockGetKnowledgeBaseCountByOwner {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetKnowledgeBaseFilesByFileUIDs *mRepositoryIMockGetKnowledgeBaseFilesByFileUIDs) Optional() *mRepositoryIMockGetKnowledgeBaseFilesByFileUIDs {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetKnowledgebaseFileByKbUIDAndFileID *mRepositoryIMockGetKnowledgebaseFileByKbUIDAndFileID) Optional() *mRepositoryIMockGetKnowledgebaseFileByKbUIDAndFileID {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetNeedProcessFiles *mRepositoryIMockGetNeedProcessFiles) Optional() *mRepositoryIMockGetNeedProcessFiles {
	mmGetNeedProcessFiles.optional = true
...
func (m *RepositoryIMock) MinimockGetNeedProcessFilesDone() bool {
	if m.GetNeedProcessFilesMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetSourceTableAndUIDByFileUIDs *mRepositoryIMockGetSourceTableAndUIDByFileUIDs) Optional() *mRepositoryIMockGetSourceTableAndUIDByFileUIDs {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetTextChunksBySource *mRepositoryIMockGetTextChunksBySource) Optional() *mRepositoryIMockGetTextChunksBySource {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetTotalChunksBySources *mRepositoryIMockGetTotalChunksBySources) Optional() *mRepositoryIMockGetTotalChunksBySources {
	mmGetTotalChunksBySources.optional = true
...
func (m *RepositoryIMock) MinimockGetTotalChunksBySourcesDone() bool {
	if m.GetTotalChunksBySourcesMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetTotalTokensByListKBUIDs *mRepositoryIMockGetTotalTokensByListKBUIDs) Optional() *mRepositoryIMockGetTotalTokensByListKBUIDs {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetTruthSourceByFileUID *mRepositoryIMockGetTruthSourceByFileUID) Optional() *mRepositoryIMockGetTruthSourceByFileUID {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmHardDeleteChunksByKbFileUID *mRepositoryIMockHardDeleteChunksByKbFileUID) Optional() *mRepositoryIMockHardDeleteChunksByKbFileUID {
...
func (m *RepositoryIMock) MinimockHardDeleteChunksByKbFileUIDDone() bool {
	if m.HardDeleteChunksByKbFileUIDMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmHardDeleteChunksByKbUID *mRepositoryIMockHardDeleteChunksByKbUID) Optional() *mRepositoryIMockHardDeleteChunksByKbUID {
	mmHardDeleteChunksByKbUID.optional = true
...
func (m *RepositoryIMock) MinimockHardDeleteChunksByKbUIDDone() bool {
	if m.HardDeleteChunksByKbUIDMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmHardDeleteConvertedFileByFileUID *mRepositoryIMockHardDeleteConvertedFileByFileUID) Optional() *mRepositoryIMockHardDeleteConvertedFileByFileUID {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmHardDeleteEmbeddingsByKbFileUID *mRepositoryIMockHardDeleteEmbeddingsByKbFileUID) Optional() *mRepositoryIMockHardDeleteEmbeddingsByKbFileUID {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmHardDeleteEmbeddingsByKbUID *mRepositoryIMockHardDeleteEmbeddingsByKbUID) Optional() *mRepositoryIMockHardDeleteEmbeddingsByKbUID {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmIncreaseKnowledgeBaseUsage *mRepositoryIMockIncreaseKnowledgeBaseUsage) Optional() *mRepositoryIMockIncreaseKnowledgeBaseUsage {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmKnowledgeBaseFileTableName *mRepositoryIMockKnowledgeBaseFileTableName) Optional() *mRepositoryIMockKnowledgeBaseFileTableName {
	mmKnowledgeBaseFileTableName.optional = true
...
func (m *RepositoryIMock) MinimockKnowledgeBaseFileTableNameDone() bool {
	if m.KnowledgeBaseFileTableNameMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}
...
type mRepositoryIMockListCatalogRuns struct {
	optional           bool
	mock               *RepositoryIMock
	defaultExpectation *RepositoryIMockListCatalogRunsExpectation
	expectations       []*RepositoryIMockListCatalogRunsExpectation

	callArgs []*RepositoryIMockListCatalogRunsParams
	mutex    sync.RWMutex

	expectedInvocations uint64
}

// RepositoryIMockListCatalogRunsExpectation specifies expectation struct of the RepositoryI.ListCatalogRuns
type RepositoryIMockListCatalogRunsExpectation struct {
	mock      *RepositoryIMock
	params    *RepositoryIMockListCatalogRunsParams
	paramPtrs *RepositoryIMockListCatalogRunsParamPtrs
	results   *RepositoryIMockListCatalogRunsResults
	Counter   uint64
}

// RepositoryIMockListCatalogRunsParams contains parameters of the RepositoryI.ListCatalogRuns
type RepositoryIMockListCatalogRunsParams struct {
	ctx          context.Context
	pageSize     int64
	page         int64
...
// RepositoryIMockListCatalogRunsParamPtrs contains pointers to parameters of the RepositoryI.ListCatalogRuns
type RepositoryIMockListCatalogRunsParamPtrs struct {
	ctx          *context.Context
	pageSize     *int64
	page         *int64
	filter       *filtering.Filter
...
// RepositoryIMockListCatalogRunsResults contains results of the RepositoryI.ListCatalogRuns
type RepositoryIMockListCatalogRunsResults struct {
	modelTriggers []*mm_repository.CatalogRun
	totalSize     int64
	err           error
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) Optional() *mRepositoryIMockListCatalogRuns {
	mmListCatalogRuns.optional = true
	return mmListCatalogRuns
}

// Expect sets up expected params for RepositoryI.ListCatalogRuns
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) Expect(ctx context.Context, pageSize int64, page int64, filter filtering.Filter, order ordering.OrderBy, catalogUID string, requesterUID string, isOwner bool) *mRepositoryIMockListCatalogRuns {
	if mmListCatalogRuns.mock.funcListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Set")
	}

	if mmListCatalogRuns.defaultExpectation == nil {
		mmListCatalogRuns.defaultExpectation = &RepositoryIMockListCatalogRunsExpectation{}
	}

	if mmListCatalogRuns.defaultExpectation.paramPtrs != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by ExpectParams functions")
	}

	mmListCatalogRuns.defaultExpectation.params = &RepositoryIMockListCatalogRunsParams{ctx, pageSize, page, filter, order, catalogUID, requesterUID, isOwner}
...
// ExpectCtxParam1 sets up expected param ctx for RepositoryI.ListCatalogRuns
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) ExpectCtxParam1(ctx context.Context) *mRepositoryIMockListCatalogRuns {
	if mmListCatalogRuns.mock.funcListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Set")
	}
	...
	if mmListCatalogRuns.defaultExpectation.params != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Expect")
	}

	if mmListCatalogRuns.defaultExpectation.paramPtrs == nil {
		mmListCatalogRuns.defaultExpectation.paramPtrs = &RepositoryIMockListCatalogRunsParamPtrs{}
	}
...
// ExpectPageSizeParam2 sets up expected param pageSize for RepositoryI.ListCatalogRuns
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) ExpectPageSizeParam2(pageSize int64) *mRepositoryIMockListCatalogRuns {
	if mmListCatalogRuns.mock.funcListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Set")
	}
	...
	mmListCatalogRuns.defaultExpectation.paramPtrs.pageSize = &pageSize

	return mmListCatalogRuns
}

// ExpectPageParam3 sets up expected param page for RepositoryI.ListCatalogRuns
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) ExpectPageParam3(page int64) *mRepositoryIMockListCatalogRuns {
	if mmListCatalogRuns.mock.funcListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Set")
	}
	...
	mmListCatalogRuns.defaultExpectation.paramPtrs.page = &page

	return mmListCatalogRuns
}

// ExpectFilterParam4 sets up expected param filter for RepositoryI.ListCatalogRuns
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) ExpectFilterParam4(filter filtering.Filter) *mRepositoryIMockListCatalogRuns {
	if mmListCatalogRuns.mock.funcListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Set")
	}
	...
	mmListCatalogRuns.defaultExpectation.paramPtrs.filter = &filter

	return mmListCatalogRuns
}

// ExpectOrderParam5 sets up expected param order for RepositoryI.ListCatalogRuns
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) ExpectOrderParam5(order ordering.OrderBy) *mRepositoryIMockListCatalogRuns {
	if mmListCatalogRuns.mock.funcListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Set")
	}
	...
	mmListCatalogRuns.defaultExpectation.paramPtrs.order = &order

	return mmListCatalogRuns
}

// ExpectCatalogUIDParam6 sets up expected param catalogUID for RepositoryI.ListCatalogRuns
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) ExpectCatalogUIDParam6(catalogUID string) *mRepositoryIMockListCatalogRuns {
	if mmListCatalogRuns.mock.funcListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Set")
	}
	...
	mmListCatalogRuns.defaultExpectation.paramPtrs.catalogUID = &catalogUID

	return mmListCatalogRuns
}

// ExpectRequesterUIDParam7 sets up expected param requesterUID for RepositoryI.ListCatalogRuns
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) ExpectRequesterUIDParam7(requesterUID string) *mRepositoryIMockListCatalogRuns {
	if mmListCatalogRuns.mock.funcListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Set")
	}
	...
	mmListCatalogRuns.defaultExpectation.paramPtrs.requesterUID = &requesterUID

	return mmListCatalogRuns
}

// ExpectIsOwnerParam8 sets up expected param isOwner for RepositoryI.ListCatalogRuns
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) ExpectIsOwnerParam8(isOwner bool) *mRepositoryIMockListCatalogRuns {
	if mmListCatalogRuns.mock.funcListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Set")
	}
	...
	mmListCatalogRuns.defaultExpectation.paramPtrs.isOwner = &isOwner

	return mmListCatalogRuns
}

// Inspect accepts an inspector function that has same arguments as the RepositoryI.ListCatalogRuns
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) Inspect(f func(ctx context.Context, pageSize int64, page int64, filter filtering.Filter, order ordering.OrderBy, catalogUID string, requesterUID string, isOwner bool)) *mRepositoryIMockListCatalogRuns {
	if mmListCatalogRuns.mock.inspectFuncListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("Inspect function is already set for RepositoryIMock.ListCatalogRuns")
	}
...
// Return sets up results that will be returned by RepositoryI.ListCatalogRuns
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) Return(modelTriggers []*mm_repository.CatalogRun, totalSize int64, err error) *RepositoryIMock {
	if mmListCatalogRuns.mock.funcListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Set")
	}

	if mmListCatalogRuns.defaultExpectation == nil {
		mmListCatalogRuns.defaultExpectation = &RepositoryIMockListCatalogRunsExpectation{mock: mmListCatalogRuns.mock}
	}
	mmListCatalogRuns.defaultExpectation.results = &RepositoryIMockListCatalogRunsResults{modelTriggers, totalSize, err}
	return mmListCatalogRuns.mock
}

// Set uses given function f to mock the RepositoryI.ListCatalogRuns method
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) Set(f func(ctx context.Context, pageSize int64, page int64, filter filtering.Filter, order ordering.OrderBy, catalogUID string, requesterUID string, isOwner bool) (modelTriggers []*mm_repository.CatalogRun, totalSize int64, err error)) *RepositoryIMock {
	if mmListCatalogRuns.defaultExpectation != nil {
		mmListCatalogRuns.mock.t.Fatalf("Default expectation is already set for the RepositoryI.ListCatalogRuns method")
	}

	if len(mmListCatalogRuns.expectations) > 0 {
		mmListCatalogRuns.mock.t.Fatalf("Some expectations are already set for the RepositoryI.ListCatalogRuns method")
	}
...
// When sets expectation for the RepositoryI.ListCatalogRuns which will trigger the result defined by the following
// Then helper
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) When(ctx context.Context, pageSize int64, page int64, filter filtering.Filter, order ordering.OrderBy, catalogUID string, requesterUID string, isOwner bool) *RepositoryIMockListCatalogRunsExpectation {
	if mmListCatalogRuns.mock.funcListCatalogRuns != nil {
		mmListCatalogRuns.mock.t.Fatalf("RepositoryIMock.ListCatalogRuns mock is already set by Set")
	}

	expectation := &RepositoryIMockListCatalogRunsExpectation{
		mock:   mmListCatalogRuns.mock,
		params: &RepositoryIMockListCatalogRunsParams{ctx, pageSize, page, filter, order, catalogUID, requesterUID, isOwner},
	}
	mmListCatalogRuns.expectations = append(mmListCatalogRuns.expectations, expectation)
	return expectation
}

// Then sets up RepositoryI.ListCatalogRuns return parameters for the expectation previously defined by the When method
func (e *RepositoryIMockListCatalogRunsExpectation) Then(modelTriggers []*mm_repository.CatalogRun, totalSize int64, err error) *RepositoryIMock {
	e.results = &RepositoryIMockListCatalogRunsResults{modelTriggers, totalSize, err}
	return e.mock
}

// Times sets number of times RepositoryI.ListCatalogRuns should be invoked
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) Times(n uint64) *mRepositoryIMockListCatalogRuns {
	if n == 0 {
		mmListCatalogRuns.mock.t.Fatalf("Times of RepositoryIMock.ListCatalogRuns mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmListCatalogRuns.expectedInvocations, n)
	return mmListCatalogRuns
}

func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) invocationsDone() bool {
...
// ListCatalogRuns implements repository.RepositoryI
func (mmListCatalogRuns *RepositoryIMock) ListCatalogRuns(ctx context.Context, pageSize int64, page int64, filter filtering.Filter, order ordering.OrderBy, catalogUID string, requesterUID string, isOwner bool) (modelTriggers []*mm_repository.CatalogRun, totalSize int64, err error) {
	...
	if mmListCatalogRuns.inspectFuncListCatalogRuns != nil {
		mmListCatalogRuns.inspectFuncListCatalogRuns(ctx, pageSize, page, filter, order, catalogUID, requesterUID, isOwner)
	}

	mm_params := RepositoryIMockListCatalogRunsParams{ctx, pageSize, page, filter, order, catalogUID, requesterUID, isOwner}
	...
	if mmListCatalogRuns.ListCatalogRunsMock.defaultExpectation != nil {
		...
		mm_got := RepositoryIMockListCatalogRunsParams{ctx, pageSize, page, filter, order, catalogUID, requesterUID, isOwner}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmListCatalogRuns.t.Errorf("RepositoryIMock.ListCatalogRuns got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.pageSize != nil && !minimock.Equal(*mm_want_ptrs.pageSize, mm_got.pageSize) {
				mmListCatalogRuns.t.Errorf("RepositoryIMock.ListCatalogRuns got unexpected parameter pageSize, want: %#v, got: %#v%s\n", *mm_want_ptrs.pageSize, mm_got.pageSize, minimock.Diff(*mm_want_ptrs.pageSize, mm_got.pageSize))
			}

			if mm_want_ptrs.page != nil && !minimock.Equal(*mm_want_ptrs.page, mm_got.page) {
				mmListCatalogRuns.t.Errorf("RepositoryIMock.ListCatalogRuns got unexpected parameter page, want: %#v, got: %#v%s\n", *mm_want_ptrs.page, mm_got.page, minimock.Diff(*mm_want_ptrs.page, mm_got.page))
			}

			if mm_want_ptrs.filter != nil && !minimock.Equal(*mm_want_ptrs.filter, mm_got.filter) {
				mmListCatalogRuns.t.Errorf("RepositoryIMock.ListCatalogRuns got unexpected parameter filter, want: %#v, got: %#v%s\n", *mm_want_ptrs.filter, mm_got.filter, minimock.Diff(*mm_want_ptrs.filter, mm_got.filter))
			}

			if mm_want_ptrs.order != nil && !minimock.Equal(*mm_want_ptrs.order, mm_got.order) {
				mmListCatalogRuns.t.Errorf("RepositoryIMock.ListCatalogRuns got unexpected parameter order, want: %#v, got: %#v%s\n", *mm_want_ptrs.order, mm_got.order, minimock.Diff(*mm_want_ptrs.order, mm_got.order))
			}

			if mm_want_ptrs.catalogUID != nil && !minimock.Equal(*mm_want_ptrs.catalogUID, mm_got.catalogUID) {
				mmListCatalogRuns.t.Errorf("RepositoryIMock.ListCatalogRuns got unexpected parameter catalogUID, want: %#v, got: %#v%s\n", *mm_want_ptrs.catalogUID, mm_got.catalogUID, minimock.Diff(*mm_want_ptrs.catalogUID, mm_got.catalogUID))
			}

			if mm_want_ptrs.requesterUID != nil && !minimock.Equal(*mm_want_ptrs.requesterUID, mm_got.requesterUID) {
				mmListCatalogRuns.t.Errorf("RepositoryIMock.ListCatalogRuns got unexpected parameter requesterUID, want: %#v, got: %#v%s\n", *mm_want_ptrs.requesterUID, mm_got.requesterUID, minimock.Diff(*mm_want_ptrs.requesterUID, mm_got.requesterUID))
			}

			if mm_want_ptrs.isOwner != nil && !minimock.Equal(*mm_want_ptrs.isOwner, mm_got.isOwner) {
				mmListCatalogRuns.t.Errorf("RepositoryIMock.ListCatalogRuns got unexpected parameter isOwner, want: %#v, got: %#v%s\n", *mm_want_ptrs.isOwner, mm_got.isOwner, minimock.Diff(*mm_want_ptrs.isOwner, mm_got.isOwner))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmListCatalogRuns.t.Errorf("RepositoryIMock.ListCatalogRuns got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmListCatalogRuns.ListCatalogRunsMock.defaultExpectation.results
		if mm_results == nil {
			mmListCatalogRuns.t.Fatal("No results are set for the RepositoryIMock.ListCatalogRuns")
		}
		return (*mm_results).modelTriggers, (*mm_results).totalSize, (*mm_results).err
	}
	if mmListCatalogRuns.funcListCatalogRuns != nil {
		return mmListCatalogRuns.funcListCatalogRuns(ctx, pageSize, page, filter, order, catalogUID, requesterUID, isOwner)
	}
	mmListCatalogRuns.t.Fatalf("Unexpected call to RepositoryIMock.ListCatalogRuns. %v %v %v %v %v %v %v %v", ctx, pageSize, page, filter, order, catalogUID, requesterUID, isOwner)
	return
}

// ListCatalogRunsAfterCounter returns a count of finished RepositoryIMock.ListCatalogRuns invocations
func (mmListCatalogRuns *RepositoryIMock) ListCatalogRunsAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmListCatalogRuns.afterListCatalogRunsCounter)
}

// ListCatalogRunsBeforeCounter returns a count of RepositoryIMock.ListCatalogRuns invocations
func (mmListCatalogRuns *RepositoryIMock) ListCatalogRunsBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmListCatalogRuns.beforeListCatalogRunsCounter)
}

// Calls returns a list of arguments used in each call to RepositoryIMock.ListCatalogRuns.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmListCatalogRuns *mRepositoryIMockListCatalogRuns) Calls() []*RepositoryIMockListCatalogRunsParams {
	mmListCatalogRuns.mutex.RLock()

	argCopy := make([]*RepositoryIMockListCatalogRunsParams, len(mmListCatalogRuns.callArgs))
...
// the number of defined expectations
func (m *RepositoryIMock) MinimockListCatalogRunsDone() bool {
...
func (m *RepositoryIMock) MinimockListCatalogRunsInspect() {
	for _, e := range m.ListCatalogRunsMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryIMock.ListCatalogRuns with params: %#v", *e.params)
		}
	}
	...
	if m.ListCatalogRunsMock.defaultExpectation != nil && afterListCatalogRunsCounter < 1 {
		if m.ListCatalogRunsMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryIMock.ListCatalogRuns")
		} else {
			m.t.Errorf("Expected call to RepositoryIMock.ListCatalogRuns with params: %#v", *m.ListCatalogRunsMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.ListCatalogRunsMock.invocationsDone() && afterListCatalogRunsCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryIMock.ListCatalogRuns but found %d calls",
			mm_atomic.LoadUint64(&m.ListCatalogRunsMock.expectedInvocations), afterListCatalogRunsCounter)
	}
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmListChunksByKbFileUID *mRepositoryIMockListChunksByKbFileUID) Optional() *mRepositoryIMockListChunksByKbFileUID {
	mmListChunksByKbFileUID.optional = true
...
func (m *RepositoryIMock) MinimockListChunksByKbFileUIDDone() bool {
	if m.ListChunksByKbFileUIDMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmListEmbeddingsByKbFileUID *mRepositoryIMockListEmbeddingsByKbFileUID) Optional() *mRepositoryIMockListEmbeddingsByKbFileUID {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmTextChunkTableName *mRepositoryIMockTextChunkTableName) Optional() *mRepositoryIMockTextChunkTableName {
	mmTextChunkTableName.optional = true
...
func (m *RepositoryIMock) MinimockTextChunkTableNameDone() bool {
	if m.TextChunkTableNameMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}
...
type mRepositoryIMockUpdateCatalogRun struct {
	optional           bool
	mock               *RepositoryIMock
	defaultExpectation *RepositoryIMockUpdateCatalogRunExpectation
	expectations       []*RepositoryIMockUpdateCatalogRunExpectation

	callArgs []*RepositoryIMockUpdateCatalogRunParams
	mutex    sync.RWMutex

	expectedInvocations uint64
}

// RepositoryIMockUpdateCatalogRunExpectation specifies expectation struct of the RepositoryI.UpdateCatalogRun
type RepositoryIMockUpdateCatalogRunExpectation struct {
	mock      *RepositoryIMock
	params    *RepositoryIMockUpdateCatalogRunParams
	paramPtrs *RepositoryIMockUpdateCatalogRunParamPtrs
	results   *RepositoryIMockUpdateCatalogRunResults
	Counter   uint64
}

// RepositoryIMockUpdateCatalogRunParams contains parameters of the RepositoryI.UpdateCatalogRun
type RepositoryIMockUpdateCatalogRunParams struct {
	ctx    context.Context
	runUID uuid.UUID
	run    *mm_repository.CatalogRun
}

// RepositoryIMockUpdateCatalogRunParamPtrs contains pointers to parameters of the RepositoryI.UpdateCatalogRun
type RepositoryIMockUpdateCatalogRunParamPtrs struct {
	ctx    *context.Context
	runUID *uuid.UUID
	run    **mm_repository.CatalogRun
}

// RepositoryIMockUpdateCatalogRunResults contains results of the RepositoryI.UpdateCatalogRun
type RepositoryIMockUpdateCatalogRunResults struct {
	err error
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) Optional() *mRepositoryIMockUpdateCatalogRun {
	mmUpdateCatalogRun.optional = true
	return mmUpdateCatalogRun
}

// Expect sets up expected params for RepositoryI.UpdateCatalogRun
func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) Expect(ctx context.Context, runUID uuid.UUID, run *mm_repository.CatalogRun) *mRepositoryIMockUpdateCatalogRun {
	if mmUpdateCatalogRun.mock.funcUpdateCatalogRun != nil {
		mmUpdateCatalogRun.mock.t.Fatalf("RepositoryIMock.UpdateCatalogRun mock is already set by Set")
	}

	if mmUpdateCatalogRun.defaultExpectation == nil {
		mmUpdateCatalogRun.defaultExpectation = &RepositoryIMockUpdateCatalogRunExpectation{}
	}

	if mmUpdateCatalogRun.defaultExpectation.paramPtrs != nil {
		mmUpdateCatalogRun.mock.t.Fatalf("RepositoryIMock.UpdateCatalogRun mock is already set by ExpectParams functions")
	}

	mmUpdateCatalogRun.defaultExpectation.params = &RepositoryIMockUpdateCatalogRunParams{ctx, runUID, run}
	for _, e := range mmUpdateCatalogRun.expectations {
		if minimock.Equal(e.params, mmUpdateCatalogRun.defaultExpectation.params) {
			mmUpdateCatalogRun.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmUpdateCatalogRun.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for RepositoryI.UpdateCatalogRun
func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) ExpectCtxParam1(ctx context.Context) *mRepositoryIMockUpdateCatalogRun {
	if mmUpdateCatalogRun.mock.funcUpdateCatalogRun != nil {
		mmUpdateCatalogRun.mock.t.Fatalf("RepositoryIMock.UpdateCatalogRun mock is already set by Set")
	}
	...
	if mmUpdateCatalogRun.defaultExpectation.params != nil {
		mmUpdateCatalogRun.mock.t.Fatalf("RepositoryIMock.UpdateCatalogRun mock is already set by Expect")
	}

	if mmUpdateCatalogRun.defaultExpectation.paramPtrs == nil {
		mmUpdateCatalogRun.defaultExpectation.paramPtrs = &RepositoryIMockUpdateCatalogRunParamPtrs{}
	}
	mmUpdateCatalogRun.defaultExpectation.paramPtrs.ctx = &ctx

	return mmUpdateCatalogRun
}

// ExpectRunUIDParam2 sets up expected param runUID for RepositoryI.UpdateCatalogRun
func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) ExpectRunUIDParam2(runUID uuid.UUID) *mRepositoryIMockUpdateCatalogRun {
	if mmUpdateCatalogRun.mock.funcUpdateCatalogRun != nil {
		mmUpdateCatalogRun.mock.t.Fatalf("RepositoryIMock.UpdateCatalogRun mock is already set by Set")
	}
	...
	mmUpdateCatalogRun.defaultExpectation.paramPtrs.runUID = &runUID

	return mmUpdateCatalogRun
}

// ExpectRunParam3 sets up expected param run for RepositoryI.UpdateCatalogRun
func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) ExpectRunParam3(run *mm_repository.CatalogRun) *mRepositoryIMockUpdateCatalogRun {
	if mmUpdateCatalogRun.mock.funcUpdateCatalogRun != nil {
		mmUpdateCatalogRun.mock.t.Fatalf("RepositoryIMock.UpdateCatalogRun mock is already set by Set")
	}
	...
	mmUpdateCatalogRun.defaultExpectation.paramPtrs.run = &run

	return mmUpdateCatalogRun
}

// Inspect accepts an inspector function that has same arguments as the RepositoryI.UpdateCatalogRun
func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) Inspect(f func(ctx context.Context, runUID uuid.UUID, run *mm_repository.CatalogRun)) *mRepositoryIMockUpdateCatalogRun {
	if mmUpdateCatalogRun.mock.inspectFuncUpdateCatalogRun != nil {
		mmUpdateCatalogRun.mock.t.Fatalf("Inspect function is already set for RepositoryIMock.UpdateCatalogRun")
	}

	mmUpdateCatalogRun.mock.inspectFuncUpdateCatalogRun = f

	return mmUpdateCatalogRun
}

// Return sets up results that will be returned by RepositoryI.UpdateCatalogRun
func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) Return(err error) *RepositoryIMock {
	if mmUpdateCatalogRun.mock.funcUpdateCatalogRun != nil {
		mmUpdateCatalogRun.mock.t.Fatalf("RepositoryIMock.UpdateCatalogRun mock is already set by Set")
	}

	if mmUpdateCatalogRun.defaultExpectation == nil {
		mmUpdateCatalogRun.defaultExpectation = &RepositoryIMockUpdateCatalogRunExpectation{mock: mmUpdateCatalogRun.mock}
	}
	mmUpdateCatalogRun.defaultExpectation.results = &RepositoryIMockUpdateCatalogRunResults{err}
	return mmUpdateCatalogRun.mock
}

// Set uses given function f to mock the RepositoryI.UpdateCatalogRun method
func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) Set(f func(ctx context.Context, runUID uuid.UUID, run *mm_repository.CatalogRun) (err error)) *RepositoryIMock {
	if mmUpdateCatalogRun.defaultExpectation != nil {
		mmUpdateCatalogRun.mock.t.Fatalf("Default expectation is already set for the RepositoryI.UpdateCatalogRun method")
	}

	if len(mmUpdateCatalogRun.expectations) > 0 {
		mmUpdateCatalogRun.mock.t.Fatalf("Some expectations are already set for the RepositoryI.UpdateCatalogRun method")
	}

	mmUpdateCatalogRun.mock.funcUpdateCatalogRun = f
	return mmUpdateCatalogRun.mock
}

// When sets expectation for the RepositoryI.UpdateCatalogRun which will trigger the result defined by the following
// Then helper
func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) When(ctx context.Context, runUID uuid.UUID, run *mm_repository.CatalogRun) *RepositoryIMockUpdateCatalogRunExpectation {
	if mmUpdateCatalogRun.mock.funcUpdateCatalogRun != nil {
		mmUpdateCatalogRun.mock.t.Fatalf("RepositoryIMock.UpdateCatalogRun mock is already set by Set")
	}

	expectation := &RepositoryIMockUpdateCatalogRunExpectation{
		mock:   mmUpdateCatalogRun.mock,
		params: &RepositoryIMockUpdateCatalogRunParams{ctx, runUID, run},
	}
	mmUpdateCatalogRun.expectations = append(mmUpdateCatalogRun.expectations, expectation)
	return expectation
}

// Then sets up RepositoryI.UpdateCatalogRun return parameters for the expectation previously defined by the When method
func (e *RepositoryIMockUpdateCatalogRunExpectation) Then(err error) *RepositoryIMock {
	e.results = &RepositoryIMockUpdateCatalogRunResults{err}
	return e.mock
}

// Times sets number of times RepositoryI.UpdateCatalogRun should be invoked
func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) Times(n uint64) *mRepositoryIMockUpdateCatalogRun {
	if n == 0 {
		mmUpdateCatalogRun.mock.t.Fatalf("Times of RepositoryIMock.UpdateCatalogRun mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmUpdateCatalogRun.expectedInvocations, n)
	return mmUpdateCatalogRun
}

func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) invocationsDone() bool {
	if len(mmUpdateCatalogRun.expectations) == 0 && mmUpdateCatalogRun.defaultExpectation == nil && mmUpdateCatalogRun.mock.funcUpdateCatalogRun == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmUpdateCatalogRun.mock.afterUpdateCatalogRunCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmUpdateCatalogRun.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// UpdateCatalogRun implements repository.RepositoryI
func (mmUpdateCatalogRun *RepositoryIMock) UpdateCatalogRun(ctx context.Context, runUID uuid.UUID, run *mm_repository.CatalogRun) (err error) {
	mm_atomic.AddUint64(&mmUpdateCatalogRun.beforeUpdateCatalogRunCounter, 1)
	defer mm_atomic.AddUint64(&mmUpdateCatalogRun.afterUpdateCatalogRunCounter, 1)

	if mmUpdateCatalogRun.inspectFuncUpdateCatalogRun != nil {
		mmUpdateCatalogRun.inspectFuncUpdateCatalogRun(ctx, runUID, run)
	}

	mm_params := RepositoryIMockUpdateCatalogRunParams{ctx, runUID, run}

	// Record call args
	mmUpdateCatalogRun.UpdateCatalogRunMock.mutex.Lock()
	mmUpdateCatalogRun.UpdateCatalogRunMock.callArgs = append(mmUpdateCatalogRun.UpdateCatalogRunMock.callArgs, &mm_params)
	mmUpdateCatalogRun.UpdateCatalogRunMock.mutex.Unlock()

	for _, e := range mmUpdateCatalogRun.UpdateCatalogRunMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
			return e.results.err
		}
	...
	if mmUpdateCatalogRun.UpdateCatalogRunMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmUpdateCatalogRun.UpdateCatalogRunMock.defaultExpectation.Counter, 1)
		mm_want := mmUpdateCatalogRun.UpdateCatalogRunMock.defaultExpectation.params
		mm_want_ptrs := mmUpdateCatalogRun.UpdateCatalogRunMock.defaultExpectation.paramPtrs

		mm_got := RepositoryIMockUpdateCatalogRunParams{ctx, runUID, run}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmUpdateCatalogRun.t.Errorf("RepositoryIMock.UpdateCatalogRun got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.runUID != nil && !minimock.Equal(*mm_want_ptrs.runUID, mm_got.runUID) {
				mmUpdateCatalogRun.t.Errorf("RepositoryIMock.UpdateCatalogRun got unexpected parameter runUID, want: %#v, got: %#v%s\n", *mm_want_ptrs.runUID, mm_got.runUID, minimock.Diff(*mm_want_ptrs.runUID, mm_got.runUID))
			}

			if mm_want_ptrs.run != nil && !minimock.Equal(*mm_want_ptrs.run, mm_got.run) {
				mmUpdateCatalogRun.t.Errorf("RepositoryIMock.UpdateCatalogRun got unexpected parameter run, want: %#v, got: %#v%s\n", *mm_want_ptrs.run, mm_got.run, minimock.Diff(*mm_want_ptrs.run, mm_got.run))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmUpdateCatalogRun.t.Errorf("RepositoryIMock.UpdateCatalogRun got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmUpdateCatalogRun.UpdateCatalogRunMock.defaultExpectation.results
		if mm_results == nil {
			mmUpdateCatalogRun.t.Fatal("No results are set for the RepositoryIMock.UpdateCatalogRun")
		}
		return (*mm_results).err
	}
	if mmUpdateCatalogRun.funcUpdateCatalogRun != nil {
		return mmUpdateCatalogRun.funcUpdateCatalogRun(ctx, runUID, run)
	}
	mmUpdateCatalogRun.t.Fatalf("Unexpected call to RepositoryIMock.UpdateCatalogRun. %v %v %v", ctx, runUID, run)
	return
}

// UpdateCatalogRunAfterCounter returns a count of finished RepositoryIMock.UpdateCatalogRun invocations
func (mmUpdateCatalogRun *RepositoryIMock) UpdateCatalogRunAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmUpdateCatalogRun.afterUpdateCatalogRunCounter)
}

// UpdateCatalogRunBeforeCounter returns a count of RepositoryIMock.UpdateCatalogRun invocations
func (mmUpdateCatalogRun *RepositoryIMock) UpdateCatalogRunBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmUpdateCatalogRun.beforeUpdateCatalogRunCounter)
}

// Calls returns a list of arguments used in each call to RepositoryIMock.UpdateCatalogRun.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmUpdateCatalogRun *mRepositoryIMockUpdateCatalogRun) Calls() []*RepositoryIMockUpdateCatalogRunParams {
	mmUpdateCatalogRun.mutex.RLock()

	argCopy := make([]*RepositoryIMockUpdateCatalogRunParams, len(mmUpdateCatalogRun.callArgs))
	copy(argCopy, mmUpdateCatalogRun.callArgs)

	mmUpdateCatalogRun.mutex.RUnlock()

	return argCopy
}

// MinimockUpdateCatalogRunDone returns true if the count of the UpdateCatalogRun invocations corresponds
// the number of defined expectations
func (m *RepositoryIMock) MinimockUpdateCatalogRunDone() bool {
	if m.UpdateCatalogRunMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.UpdateCatalogRunMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.UpdateCatalogRunMock.invocationsDone()
}

// MinimockUpdateCatalogRunInspect logs each unmet expectation
func (m *RepositoryIMock) MinimockUpdateCatalogRunInspect() {
	for _, e := range m.UpdateCatalogRunMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryIMock.UpdateCatalogRun with params: %#v", *e.params)
		}
	}

	afterUpdateCatalogRunCounter := mm_atomic.LoadUint64(&m.afterUpdateCatalogRunCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.UpdateCatalogRunMock.defaultExpectation != nil && afterUpdateCatalogRunCounter < 1 {
		if m.UpdateCatalogRunMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryIMock.UpdateCatalogRun")
		} else {
			m.t.Errorf("Expected call to RepositoryIMock.UpdateCatalogRun with params: %#v", *m.UpdateCatalogRunMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcUpdateCatalogRun != nil && afterUpdateCatalogRunCounter < 1 {
		m.t.Error("Expected call to RepositoryIMock.UpdateCatalogRun")
	}

	if !m.UpdateCatalogRunMock.invocationsDone() && afterUpdateCatalogRunCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryIMock.UpdateCatalogRun but found %d calls",
			mm_atomic.LoadUint64(&m.UpdateCatalogRunMock.expectedInvocations), afterUpdateCatalogRunCounter)
	}
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmUpdateChunk *mRepositoryIMockUpdateChunk) Optional() *mRepositoryIMockUpdateChunk {
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmUpdateKbFileExtraMetaData *mRepositoryIMockUpdateKbFileExtraMetaData) Optional() *mRepositoryIMockUpdateKbFileExtraMetaData {
	mmUpdateKbFileExtraMetaData.optional = true
...
func (m *RepositoryIMock) MinimockUpdateKbFileExtraMetaDataDone() bool {
	if m.UpdateKbFileExtraMetaDataMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmUpdateKnowledgeBaseFile *mRepositoryIMockUpdateKnowledgeBaseFile) Optional() *mRepositoryIMockUpdateKnowledgeBaseFile {
...
type mRepositoryIMockUpsertCatalogRun struct {
	optional           bool
	mock               *RepositoryIMock
	defaultExpectation *RepositoryIMockUpsertCatalogRunExpectation
	expectations       []*RepositoryIMockUpsertCatalogRunExpectation

	callArgs []*RepositoryIMockUpsertCatalogRunParams
	mutex    sync.RWMutex

	expectedInvocations uint64
}

// RepositoryIMockUpsertCatalogRunExpectation specifies expectation struct of the RepositoryI.CreateCatalogRun
type RepositoryIMockUpsertCatalogRunExpectation struct {
	mock      *RepositoryIMock
	params    *RepositoryIMockUpsertCatalogRunParams
	paramPtrs *RepositoryIMockUpsertCatalogRunParamPtrs
	results   *RepositoryIMockUpsertCatalogRunResults
	Counter   uint64
}

// RepositoryIMockUpsertCatalogRunParams contains parameters of the RepositoryI.CreateCatalogRun
type RepositoryIMockUpsertCatalogRunParams struct {
	ctx context.Context
	run *mm_repository.CatalogRun
}

// RepositoryIMockUpsertCatalogRunParamPtrs contains pointers to parameters of the RepositoryI.CreateCatalogRun
type RepositoryIMockUpsertCatalogRunParamPtrs struct {
	ctx *context.Context
	run **mm_repository.CatalogRun
}

// RepositoryIMockUpsertCatalogRunResults contains results of the RepositoryI.CreateCatalogRun
type RepositoryIMockUpsertCatalogRunResults struct {
	cp1 *mm_repository.CatalogRun
	err error
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmUpsertCatalogRun *mRepositoryIMockUpsertCatalogRun) Optional() *mRepositoryIMockUpsertCatalogRun {
	mmUpsertCatalogRun.optional = true
	return mmUpsertCatalogRun
}

// Expect sets up expected params for RepositoryI.CreateCatalogRun
func (mmUpsertCatalogRun *mRepositoryIMockUpsertCatalogRun) Expect(ctx context.Context, run *mm_repository.CatalogRun) *mRepositoryIMockUpsertCatalogRun {
	if mmUpsertCatalogRun.mock.funcUpsertCatalogRun != nil {
		mmUpsertCatalogRun.mock.t.Fatalf("RepositoryIMock.CreateCatalogRun mock is already set by Set")
	}

	if mmUpsertCatalogRun.defaultExpectation == nil {
		mmUpsertCatalogRun.defaultExpectation = &RepositoryIMockUpsertCatalogRunExpectation{}
	}

	if mmUpsertCatalogRun.defaultExpectation.paramPtrs != nil {
		mmUpsertCatalogRun.mock.t.Fatalf("RepositoryIMock.CreateCatalogRun mock is already set by ExpectParams functions")
	}

	mmUpsertCatalogRun.defaultExpectation.params = &RepositoryIMockUpsertCatalogRunParams{ctx, run}
	for _, e := range mmUpsertCatalogRun.expectations {
		if minimock.Equal(e.params, mmUpsertCatalogRun.defaultExpectation.params) {
			mmUpsertCatalogRun.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmUpsertCatalogRun.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for RepositoryI.CreateCatalogRun
func (mmUpsertCatalogRun *mRepositoryIMockUpsertCatalogRun) ExpectCtxParam1(ctx context.Context) *mRepositoryIMockUpsertCatalogRun {
	if mmUpsertCatalogRun.mock.funcUpsertCatalogRun != nil {
		mmUpsertCatalogRun.mock.t.Fatalf("RepositoryIMock.CreateCatalogRun mock is already set by Set")
	}
	...
	if mmUpsertCatalogRun.defaultExpectation.params != nil {
		mmUpsertCatalogRun.mock.t.Fatalf("RepositoryIMock.CreateCatalogRun mock is already set by Expect")
	}

	if mmUpsertCatalogRun.defaultExpectation.paramPtrs == nil {
		mmUpsertCatalogRun.defaultExpectation.paramPtrs = &RepositoryIMockUpsertCatalogRunParamPtrs{}
	}
	mmUpsertCatalogRun.defaultExpectation.paramPtrs.ctx = &ctx

	return mmUpsertCatalogRun
}

// ExpectRunParam2 sets up expected param run for RepositoryI.CreateCatalogRun
func (mmUpsertCatalogRun *mRepositoryIMockUpsertCatalogRun) ExpectRunParam2(run *mm_repository.CatalogRun) *mRepositoryIMockUpsertCatalogRun {
	if mmUpsertCatalogRun.mock.funcUpsertCatalogRun != nil {
		mmUpsertCatalogRun.mock.t.Fatalf("RepositoryIMock.CreateCatalogRun mock is already set by Set")
	}
	...
	mmUpsertCatalogRun.defaultExpectation.paramPtrs.run = &run

	return mmUpsertCatalogRun
}

// Inspect accepts an inspector function that has same arguments as the RepositoryI.CreateCatalogRun
func (mmUpsertCatalogRun *mRepositoryIMockUpsertCatalogRun) Inspect(f func(ctx context.Context, run *mm_repository.CatalogRun)) *mRepositoryIMockUpsertCatalogRun {
	if mmUpsertCatalogRun.mock.inspectFuncUpsertCatalogRun != nil {
		mmUpsertCatalogRun.mock.t.Fatalf("Inspect function is already set for RepositoryIMock.CreateCatalogRun")
	}

	mmUpsertCatalogRun.mock.inspectFuncUpsertCatalogRun = f

	return mmUpsertCatalogRun
}

// Return sets up results that will be returned by RepositoryI.CreateCatalogRun
func (mmUpsertCatalogRun *mRepositoryIMockUpsertCatalogRun) Return(cp1 *mm_repository.CatalogRun, err error) *RepositoryIMock {
	if mmUpsertCatalogRun.mock.funcUpsertCatalogRun != nil {
		mmUpsertCatalogRun.mock.t.Fatalf("RepositoryIMock.CreateCatalogRun mock is already set by Set")
	}

	if mmUpsertCatalogRun.defaultExpectation == nil {
		mmUpsertCatalogRun.defaultExpectation = &RepositoryIMockUpsertCatalogRunExpectation{mock: mmUpsertCatalogRun.mock}
	}
	mmUpsertCatalogRun.defaultExpectation.results = &RepositoryIMockUpsertCatalogRunResults{cp1, err}
	return mmUpsertCatalogRun.mock
}

// Set uses given function f to mock the RepositoryI.CreateCatalogRun method
func (mmUpsertCatalogRun *mRepositoryIMockUpsertCatalogRun) Set(f func(ctx context.Context, run *mm_repository.CatalogRun) (cp1 *mm_repository.CatalogRun, err error)) *RepositoryIMock {
	if mmUpsertCatalogRun.defaultExpectation != nil {
		mmUpsertCatalogRun.mock.t.Fatalf("Default expectation is already set for the RepositoryI.CreateCatalogRun method")
	}

	if len(mmUpsertCatalogRun.expectations) > 0 {
		mmUpsertCatalogRun.mock.t.Fatalf("Some expectations are already set for the RepositoryI.CreateCatalogRun method")
	}

	mmUpsertCatalogRun.mock.funcUpsertCatalogRun = f
	return mmUpsertCatalogRun.mock
}

// When sets expectation for the RepositoryI.CreateCatalogRun which will trigger the result defined by the following
// Then helper
func (mmUpsertCatalogRun *mRepositoryIMockUpsertCatalogRun) When(ctx context.Context, run *mm_repository.CatalogRun) *RepositoryIMockUpsertCatalogRunExpectation {
	if mmUpsertCatalogRun.mock.funcUpsertCatalogRun != nil {
		mmUpsertCatalogRun.mock.t.Fatalf("RepositoryIMock.CreateCatalogRun mock is already set by Set")
	}

	expectation := &RepositoryIMockUpsertCatalogRunExpectation{
		mock:   mmUpsertCatalogRun.mock,
		params: &RepositoryIMockUpsertCatalogRunParams{ctx, run},
	}
	mmUpsertCatalogRun.expectations = append(mmUpsertCatalogRun.expectations, expectation)
	return expectation
}

// Then sets up RepositoryI.CreateCatalogRun return parameters for the expectation previously defined by the When method
func (e *RepositoryIMockUpsertCatalogRunExpectation) Then(cp1 *mm_repository.CatalogRun, err error) *RepositoryIMock {
	e.results = &RepositoryIMockUpsertCatalogRunResults{cp1, err}
	return e.mock
}

// Times sets number of times RepositoryI.CreateCatalogRun should be invoked
func (mmUpsertCatalogRun *mRepositoryIMockUpsertCatalogRun) Times(n uint64) *mRepositoryIMockUpsertCatalogRun {
	if n == 0 {
		mmUpsertCatalogRun.mock.t.Fatalf("Times of RepositoryIMock.CreateCatalogRun mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmUpsertCatalogRun.expectedInvocations, n)
	return mmUpsertCatalogRun
}

func (mmUpsertCatalogRun *mRepositoryIMockUpsertCatalogRun) invocationsDone() bool {
	if len(mmUpsertCatalogRun.expectations) == 0 && mmUpsertCatalogRun.defaultExpectation == nil && mmUpsertCatalogRun.mock.funcUpsertCatalogRun == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmUpsertCatalogRun.mock.afterUpsertCatalogRunCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmUpsertCatalogRun.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// UpsertCatalogRun implements repository.RepositoryI
func (mmUpsertCatalogRun *RepositoryIMock) CreateCatalogRun(ctx context.Context, run *mm_repository.CatalogRun) (cp1 *mm_repository.CatalogRun, err error) {
	mm_atomic.AddUint64(&mmUpsertCatalogRun.beforeUpsertCatalogRunCounter, 1)
	defer mm_atomic.AddUint64(&mmUpsertCatalogRun.afterUpsertCatalogRunCounter, 1)

	if mmUpsertCatalogRun.inspectFuncUpsertCatalogRun != nil {
		mmUpsertCatalogRun.inspectFuncUpsertCatalogRun(ctx, run)
	}

	mm_params := RepositoryIMockUpsertCatalogRunParams{ctx, run}

	// Record call args
	mmUpsertCatalogRun.UpsertCatalogRunMock.mutex.Lock()
	mmUpsertCatalogRun.UpsertCatalogRunMock.callArgs = append(mmUpsertCatalogRun.UpsertCatalogRunMock.callArgs, &mm_params)
	mmUpsertCatalogRun.UpsertCatalogRunMock.mutex.Unlock()

	for _, e := range mmUpsertCatalogRun.UpsertCatalogRunMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
			return e.results.cp1, e.results.err
		}
	...
	if mmUpsertCatalogRun.UpsertCatalogRunMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmUpsertCatalogRun.UpsertCatalogRunMock.defaultExpectation.Counter, 1)
		mm_want := mmUpsertCatalogRun.UpsertCatalogRunMock.defaultExpectation.params
		mm_want_ptrs := mmUpsertCatalogRun.UpsertCatalogRunMock.defaultExpectation.paramPtrs

		mm_got := RepositoryIMockUpsertCatalogRunParams{ctx, run}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmUpsertCatalogRun.t.Errorf("RepositoryIMock.CreateCatalogRun got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.run != nil && !minimock.Equal(*mm_want_ptrs.run, mm_got.run) {
				mmUpsertCatalogRun.t.Errorf("RepositoryIMock.CreateCatalogRun got unexpected parameter run, want: %#v, got: %#v%s\n", *mm_want_ptrs.run, mm_got.run, minimock.Diff(*mm_want_ptrs.run, mm_got.run))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmUpsertCatalogRun.t.Errorf("RepositoryIMock.CreateCatalogRun got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmUpsertCatalogRun.UpsertCatalogRunMock.defaultExpectation.results
		if mm_results == nil {
			mmUpsertCatalogRun.t.Fatal("No results are set for the RepositoryIMock.CreateCatalogRun")
		}
		return (*mm_results).cp1, (*mm_results).err
	}
	if mmUpsertCatalogRun.funcUpsertCatalogRun != nil {
		return mmUpsertCatalogRun.funcUpsertCatalogRun(ctx, run)
	}
	mmUpsertCatalogRun.t.Fatalf("Unexpected call to RepositoryIMock.CreateCatalogRun. %v %v", ctx, run)
	return
}

// UpsertCatalogRunAfterCounter returns a count of finished RepositoryIMock.UpsertCatalogRun invocations
func (mmUpsertCatalogRun *RepositoryIMock) UpsertCatalogRunAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmUpsertCatalogRun.afterUpsertCatalogRunCounter)
}

// UpsertCatalogRunBeforeCounter returns a count of RepositoryIMock.UpsertCatalogRun invocations
func (mmUpsertCatalogRun *RepositoryIMock) UpsertCatalogRunBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmUpsertCatalogRun.beforeUpsertCatalogRunCounter)
}

// Calls returns a list of arguments used in each call to RepositoryIMock.UpsertCatalogRun.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmUpsertCatalogRun *mRepositoryIMockUpsertCatalogRun) Calls() []*RepositoryIMockUpsertCatalogRunParams {
	mmUpsertCatalogRun.mutex.RLock()

	argCopy := make([]*RepositoryIMockUpsertCatalogRunParams, len(mmUpsertCatalogRun.callArgs))
	copy(argCopy, mmUpsertCatalogRun.callArgs)

	mmUpsertCatalogRun.mutex.RUnlock()

	return argCopy
}

// MinimockUpsertCatalogRunDone returns true if the count of the UpsertCatalogRun invocations corresponds
// the number of defined expectations
func (m *RepositoryIMock) MinimockUpsertCatalogRunDone() bool {
	if m.UpsertCatalogRunMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.UpsertCatalogRunMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.UpsertCatalogRunMock.invocationsDone()
}

// MinimockUpsertCatalogRunInspect logs each unmet expectation
func (m *RepositoryIMock) MinimockUpsertCatalogRunInspect() {
	for _, e := range m.UpsertCatalogRunMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryIMock.CreateCatalogRun with params: %#v", *e.params)
		}
	}

	afterUpsertCatalogRunCounter := mm_atomic.LoadUint64(&m.afterUpsertCatalogRunCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.UpsertCatalogRunMock.defaultExpectation != nil && afterUpsertCatalogRunCounter < 1 {
		if m.UpsertCatalogRunMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryIMock.CreateCatalogRun")
		} else {
			m.t.Errorf("Expected call to RepositoryIMock.CreateCatalogRun with params: %#v", *m.UpsertCatalogRunMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcUpsertCatalogRun != nil && afterUpsertCatalogRunCounter < 1 {
		m.t.Error("Expected call to RepositoryIMock.CreateCatalogRun")
	}

	if !m.UpsertCatalogRunMock.invocationsDone() && afterUpsertCatalogRunCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryIMock.CreateCatalogRun but found %d calls",
			mm_atomic.LoadUint64(&m.UpsertCatalogRunMock.expectedInvocations), afterUpsertCatalogRunCounter)
	}
}
...
func (m *RepositoryIMock) MinimockFinish() {
	m.finishOnce.Do(func() {
		if !m.minimockDone() {
			...
			m.MinimockUpdateCatalogRunInspect()
			...
			m.MinimockUpsertCatalogRunInspect()
...
func (m *RepositoryIMock) minimockDone() bool {
	...
	return done &&
		...
		m.MinimockUpdateCatalogRunDone() &&
		...
		m.MinimockUpsertCatalogRunDone() &&
