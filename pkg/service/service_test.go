...
func TestService_ListRepositoryTags(t *testing.T) {
	...
	for _, tc := range testcases {
		c.Run(tc.name, func(c *qt.C) {
			...
			s := service.NewService(repository, nil, nil, nil, registry, nil, nil, nil, nil, nil, nil, nil, nil, nil)
			req := newReq(tc.in)
...
func TestService_CreateRepositoryTag(t *testing.T) {
	...
	c.Run("nok - invalid name", func(c *qt.C) {
		...
		s := service.NewService(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	...
	c.Run("nok - repo error", func(c *qt.C) {
		...
		s := service.NewService(repository, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
		_, err := s.CreateRepositoryTag(ctx, req)
