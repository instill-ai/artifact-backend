...
// TextChunk is a struct that represents a chunk of text.
...
func GetChunksFromResponse(resp *pipelinepb.TriggerNamespacePipelineReleaseResponse) ([]TextChunk, error) {
	if resp == nil || len(resp.Outputs) == 0 {
