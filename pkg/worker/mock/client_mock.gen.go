...
func (mmCreateCache *mClientMockCreateCache) Expect(ctx context.Context, files []mm_ai.FileContent, ttl time.Duration) *mClientMockCreateCache {
	...
	mmCreateCache.defaultExpectation.params = &ClientMockCreateCacheParams{ctx, files, ttl}
...
func (mmCreateCache *mClientMockCreateCache) Inspect(f func(ctx context.Context, files []mm_ai.FileContent, ttl time.Duration)) *mClientMockCreateCache {
...
func (mmCreateCache *mClientMockCreateCache) Set(f func(ctx context.Context, files []mm_ai.FileContent, ttl time.Duration) (cp1 *mm_ai.CacheResult, err error)) *ClientMock {
	if mmCreateCache.defaultExpectation != nil {
...
// Then helper
func (mmCreateCache *mClientMockCreateCache) When(ctx context.Context, files []mm_ai.FileContent, ttl time.Duration) *ClientMockCreateCacheExpectation {
	if mmCreateCache.mock.funcCreateCache != nil {
		mmCreateCache.mock.t.Fatalf("ClientMock.CreateCache mock is already set by Set")
	}
	...
	expectation := &ClientMockCreateCacheExpectation{
		...
		params:             &ClientMockCreateCacheParams{ctx, files, ttl},
...
func (mmCreateCache *ClientMock) CreateCache(ctx context.Context, files []mm_ai.FileContent, ttl time.Duration) (cp1 *mm_ai.CacheResult, err error) {
	...
	if mmCreateCache.inspectFuncCreateCache != nil {
		mmCreateCache.inspectFuncCreateCache(ctx, files, ttl)
	}

	mm_params := ClientMockCreateCacheParams{ctx, files, ttl}
	...
	if mmCreateCache.CreateCacheMock.defaultExpectation != nil {
		...
		mm_got := ClientMockCreateCacheParams{ctx, files, ttl}
	...
	if mmCreateCache.funcCreateCache != nil {
		return mmCreateCache.funcCreateCache(ctx, files, ttl)
	}
	mmCreateCache.t.Fatalf("Unexpected call to ClientMock.CreateCache. %v %v %v", ctx, files, ttl)
	return
}
